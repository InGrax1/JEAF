...
- Iconos PWA (192/512/maskable/apple-touch-icon/favicon) generados a partir de la marca "J" ya usada en la barra lateral (círculo negro institucional + letra blanca), en `public/`.
